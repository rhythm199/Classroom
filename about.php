        ...
        <div class="col-md-6">
        <h2>ABOUT CLASSROOMS</h2>
        <p>The <strong>“ Classrooms”</strong> Website (web based application) is useful for the
...
In this application, student can attend his\her missed classes from e-learn.</p>
        ...
        <p class="footer text-center">Copyright &copy;Classroom 2021</p>
