...
<header id="myCarousel" class="carousel slide">
	...
	<div class="carousel-inner">
		...
		<div class="item active">
			<div class="fill" style="background-image:url('images/123.png');"></div>
			<div class="carousel-caption">
				<a href="registrationform"><h2 style="color: black;">NEW USER<BR>Register Today</h2></a>
			</div>
		</div>
		<div class="item">
			<div class="fill" style="background-image:url('images/123.png');"></div>
			<div class="carousel-caption">
				<a href="takeassessment"><h1 style="color: black; ">Take Assessment</h2>
                </div>
            </div>
        </div>
        <!-- Controls -->
...
<div class="container" style="max-width: 1200px;">
	...
	<div class="row">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<ul style="list-style-type:disc">
						<li>
							<p>The “ Classrooms” Website (web based application) is useful for the
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<ul style="list-style-type:disc">
						...
						<li>To make the institute truly a Based Institute.
						</li>
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4><i class="fa fa-fw fa-compass"></i> COURSES</h4>
				</div>
				<div class="panel-body">
					<p>
					<ul style="list-style-type:disc">
